...
A field projection in GraphQL specifies which fields are included in the query response. When projections are exposed without strict controls, an attacker can abuse them to extract unauthorized or sensitive fields.
