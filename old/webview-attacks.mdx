...
2. **Crafting the Attack**: Upon discovering this, the attacker could craft a malicious website containing a script such as `<scriptalert(document.cookie) </script`. This script, when executed, will display a pop-up showing the cookies of the current web page.
